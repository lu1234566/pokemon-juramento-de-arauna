...
static const u16 sBrendanCredits_Pal[]    = INCGFX_U16("graphics/intro/scene_2/protagonist_m_credits.png", ".gbapal");
static const u32 sBrendanCredits_Gfx[]    = INCGFX_U32("graphics/intro/scene_2/protagonist_m_credits.png", ".4bpp.lz");
static const u16 sMayCredits_Pal[]        = INCGFX_U16("graphics/intro/scene_2/protagonist_f_credits.png", ".gbapal");
static const u16 sUnused[0xF0]            = {0};
static const u32 sMayCredits_Gfx[]        = INCGFX_U32("graphics/intro/scene_2/protagonist_f_credits.png", ".4bpp.lz");
static const u32 sBicycle_Gfx[]           = INCGFX_U32("graphics/intro/scene_2/arauna_bicycle.png", ".4bpp.lz");
