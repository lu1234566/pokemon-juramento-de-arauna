...
static const u8 sStaticDescription[] = _("Contact may paralyze.");
static const u8 sVoltAbsorbDescription[] = _("Turns ELECTRIC into health.");
...
static const u8 sShieldDustDescription[] = _("Blocks added effects.");
...
static const u8 sLevitateDescription[] = _("Gives immunity to GROUND.");
...
static const u8 sSereneGraceDescription[] = _("Ups added effect chance.");
static const u8 sSwiftSwimDescription[] = _("Ups SPEED in rain.");
static const u8 sChlorophyllDescription[] = _("Ups SPEED in sunshine.");
static const u8 sIlluminateDescription[] = _("Encounters POKéMON easier.");
...
static const u8 sPressureDescription[] = _("Wears down the foe's PP.");
...
static const u8 sFlameBodyDescription[] = _("Contact may burn.");
...
static const u8 sCuteCharmDescription[] = _("Contact may cause love.");
...
{
    [ABILITY_NONE] = _("-------"),
    [ABILITY_STENCH] = _("Foul Body"),
    [ABILITY_DRIZZLE] = _("DRIZZLE"),
    [ABILITY_SPEED_BOOST] = _("Rhythm"),
    [ABILITY_BATTLE_ARMOR] = _("Grim Face"),
    [ABILITY_STURDY] = _("STURDY"),
    [ABILITY_DAMP] = _("DAMP"),
    [ABILITY_LIMBER] = _("Escape"),
    [ABILITY_SAND_VEIL] = _("Dust Cloud"),
    [ABILITY_STATIC] = _("Static"),
    [ABILITY_VOLT_ABSORB] = _("Motor Drive"),
    ...
    [ABILITY_CLEAR_BODY] = _("Metal Body"),
    [ABILITY_NATURAL_CURE] = _("Magic Veil"),
    [ABILITY_LIGHTNING_ROD] = _("LIGHTNINGROD"),
    [ABILITY_SERENE_GRACE] = _("Omen"),
    [ABILITY_SWIFT_SWIM] = _("Swift Wind"),
    [ABILITY_CHLOROPHYLL] = _("Leaf Veil"),
    [ABILITY_ILLUMINATE] = _("Scent"),
    [ABILITY_TRACE] = _("TRACE"),
    [ABILITY_HUGE_POWER] = _("HUGE POWER"),
    [ABILITY_POISON_POINT] = _("POISON POINT"),
    [ABILITY_INNER_FOCUS] = _("Courage"),
    [ABILITY_MAGMA_ARMOR] = _("MAGMA ARMOR"),
    [ABILITY_WATER_VEIL] = _("Wet Body"),
    [ABILITY_MAGNET_PULL] = _("MAGNET PULL"),
    [ABILITY_SOUNDPROOF] = _("SOUNDPROOF"),
    [ABILITY_RAIN_DISH] = _("RAIN DISH"),
    [ABILITY_SAND_STREAM] = _("Sand Cloud"),
    [ABILITY_PRESSURE] = _("Old Soul"),
    [ABILITY_THICK_FAT] = _("THICK FAT"),
    [ABILITY_EARLY_BIRD] = _("EARLY BIRD"),
    [ABILITY_FLAME_BODY] = _("Flame Body"),
    [ABILITY_RUN_AWAY] = _("Runner"),
    [ABILITY_KEEN_EYE] = _("Keen Eye"),
    [ABILITY_HYPER_CUTTER] = _("Quick Tear"),
    [ABILITY_PICKUP] = _("Harvest"),
    [ABILITY_TRUANT] = _("Playful"),
    [ABILITY_HUSTLE] = _("Weak Spot"),
    [ABILITY_CUTE_CHARM] = _("Charm"),
    [ABILITY_PLUS] = _("PLUS"),
    [ABILITY_MINUS] = _("MINUS"),
    [ABILITY_FORECAST] = _("FORECAST"),
    [ABILITY_STICKY_HOLD] = _("Mischief"),
    [ABILITY_SHED_SKIN] = _("Shed"),
    [ABILITY_GUTS] = _("Guts"),
    [ABILITY_MARVEL_SCALE] = _("DragonScale"),
    ...
    [ABILITY_ROCK_HEAD] = _("Rock Body"),
    [ABILITY_DROUGHT] = _("DROUGHT"),
    [ABILITY_ARENA_TRAP] = _("Digger"),
    [ABILITY_VITAL_SPIRIT] = _("Faithful"),
    [ABILITY_WHITE_SMOKE] = _("WHITE SMOKE"),
    [ABILITY_PURE_POWER] = _("PURE POWER"),
    [ABILITY_SHELL_ARMOR] = _("Hard Claw"),
