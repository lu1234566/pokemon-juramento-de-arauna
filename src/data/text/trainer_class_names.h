const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("HORIZON"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("REMEMBRANCER"),
    [TRAINER_CLASS_EXPERT] = _("EXPERT"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("HORIZON ADM"),
    [TRAINER_CLASS_BLACK_BELT] = _("BLACK BELT"),
    [TRAINER_CLASS_AQUA_LEADER] = _("HORIZON"),
