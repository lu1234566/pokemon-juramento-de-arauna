const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("HORIZONTE"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("LEMBRANTE"),
    [TRAINER_CLASS_EXPERT] = _("EXPERT"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("HORIZ. ADM"),
    [TRAINER_CLASS_BLACK_BELT] = _("BLACK BELT"),
    [TRAINER_CLASS_AQUA_LEADER] = _("HORIZONTE"),
    ...
    [TRAINER_CLASS_ELITE_FOUR] = _("CASA MAIOR"),
    ...
    [TRAINER_CLASS_CHAMPION] = _("CAMPEA"),
