...
const u8 gText_MatchCallBeauty_Jessica_Intro1[] = _("I love the ARAUNA PRESERVE.");
...
const u8 gText_MatchCallEliteFour_Phoebe_Intro2[] = _("MEMORIAL DOS NOMES is doing?");
