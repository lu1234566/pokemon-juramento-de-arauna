const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LUAR_DE_JACI] = _("JACI MOON"),
    [MOVE_JURAMENTO_DE_ARAUANA] = _("ARAUANA OATH"),
    [MOVE_ECLIPSE_DIVINO] = _("ECLIPSE"),
    [MOVE_VIRA_LATA_CELESTE] = _("CELESTIAL ST"),
    [MOVE_RAJADA_DO_BANHADO] = _("WETLAND BURS"),
    [MOVE_MARTELO_DE_GRANITO] = _("GRANITE HAMM"),
    [MOVE_FOGO_FATUO_ANCESTRAL] = _("ANCESTRAL WI"),
    [MOVE_PASSO_AO_CONTRARIO] = _("BACKWARD STE"),
    [MOVE_CANTO_DA_IARA] = _("IARA SONG"),
    [MOVE_REDEMOINHO_DO_SACI] = _("SACI WHIRLWI"),
    [MOVE_ENCANTO_DO_BOTO] = _("RIVER ENCHAN"),
    [MOVE_ABRACO_DA_BOIUNA] = _("BOIUNA EMBRA"),
    [MOVE_GALOPE_SEM_CABECA] = _("HEADLESS GAL"),
    [MOVE_MARE_DA_MAE] = _("MOTHER TIDE"),
    [MOVE_FORJA_DE_OGUM] = _("OGUN FORGE"),
    [MOVE_OLHAR_DA_COBRA_GRANDE] = _("GREAT SERPEN"),
    [MOVE_AURORA_DE_GUARACI] = _("GUARACI DAWN"),
    [MOVE_TROVAO_DE_TUPA] = _("TUPA THUNDER"),
    [MOVE_CORRENTEZA_SUPREMA] = _("SUPREME CURR"),
    [MOVE_INCENDIO_PRIMORDIAL] = _("PRIMORDIAL B"),
    [MOVE_MARULHO_ATLANTICO] = _("ATLANTIC SUR"),
    [MOVE_ESSENCIA_PRIMORDIAL] = _("PRIMORDIAL E"),
};
