const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_CIRO_CONSORCIO] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CIRO_FASE1] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(CIRO_CONSORCIO, gTrainerFrontPic_CiroConsorcio, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CIRO_FASE1, gTrainerFrontPic_CiroFase1, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(CIRO_CONSORCIO, gTrainerPalette_CiroConsorcio),
    TRAINER_PAL(CIRO_FASE1, gTrainerPalette_CiroFase1),
};
