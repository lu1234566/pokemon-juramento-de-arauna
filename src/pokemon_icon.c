...
{
#include "data/pokemon/icon_palette_indices.h"
};
...
// Vanilla left these three declared but pointing at nothing. Arauna fills them,
// which is free: LoadMonIconPalettes already loads all six tags.
