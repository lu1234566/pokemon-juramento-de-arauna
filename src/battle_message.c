...
static const u8 sText_DontLeaveBirch[] = _("ANAHI: Don't leave me here!\p");
...
static const u8 sText_WallyUsedItem[] = _("VAL used\n{B_LAST_ITEM}!");
...
static const u8 sText_Lanettes[] = _("LENITA's");
...
const u8 gText_BattleWallyName[] = _("VAL");
