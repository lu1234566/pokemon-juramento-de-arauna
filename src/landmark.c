...
static const u8 LandmarkName_NewMauville[] = _("USINA VELHA");
static const u8 LandmarkName_TrickHouse[] = _("CASA DOS TRUQUES");
...
static const u8 LandmarkName_SafariZoneEntrance[] = _("ENTRADA DA RESERVA");
static const u8 LandmarkName_MtPyre[] = _("MEMORIAL DOS NOMES");
static const u8 LandmarkName_ShoalCave[] = _("GRUTA DA MARE");
...
static const u8 LandmarkName_IslandCave[] = _("GRUTA DA ILHA");
...
static const u8 LandmarkName_DesertUnderpass[] = _("PASSAGEM SECA");
