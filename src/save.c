...
// Pinned so that spending reserved padding inside these structs can never
// silently grow them and invalidate every existing save.
STATIC_ASSERT(sizeof(struct SaveBlock2) == 0xF2C, SaveBlock2SizePinned);
