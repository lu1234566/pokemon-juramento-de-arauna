...
def main() -> None:
    ...
    required_story_files = ("birch_speech.inc", "map_lab.inc", "opening.inc", "route.inc", "ruin.inc", "chamber.inc", "porto_das_redes.inc")
    ...
    wrappers = ("birch_speech", "arauna/map_lab", "arauna/opening", "arauna/route", "arauna/ruin", "arauna/chamber", "arauna/porto_das_redes")
    ...
    print("English runtime validated: fixed -en build, 386 Dex entries and 7 story packs")
