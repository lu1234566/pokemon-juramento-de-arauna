...
- nome universal ou nomes localizados;
- silhuetas e concept art dos três estágios;
- paletas normal e shiny;
- sprite frontal animado, traseiro e ícone;
- tipos, habilidades, stats e crescimento;
- learnset, TMs e egg moves;
- método de evolução;
- entradas de Pokédex `pt-BR` e `en`;
