...
EXPECTED_RENDERER_ORDER = (
    ...
    'render_tv_ribbons_and_circuit_en.py',
    'render_tv_base_secrets_en.py',
    'render_tv_contest_updates_en.py',
    'render_tv_reporters_en.py',
    'render_apprentice_en.py',
    'render_multi_partner_room_en.py',
    'render_mauville_man_en.py',
    'render_battle_arena_lobby_en.py',
    ...
    'render_battle_pyramid_lobby_en.py',
    'render_battle_pyramid_floor_en.py',
    'render_contest_hall_en.py',
    'render_cable_club_en.py',
    'render_battle_tent_en.py',
    'render_frontier_lounges_en.py',
    'render_secret_base_trainers_en.py',
    'render_move_tutors_en.py',
    'render_lilycove_ladies_en.py',
    'render_berry_blender_en.py',
    'render_pokemon_news_en.py',
    'render_reserva_arauna_en.py',
    'render_battle_dome_board_en.py',
    'render_battle_dome_battle_room_en.py',
    'render_exchange_service_corner_en.py',
    'render_trainer_hill_en.py',
    'render_trick_house_en.py',
    'render_contest_strings_en.py',
    'render_encruzilhada_amusements_en.py',
    'render_lottery_corner_en.py',
    'render_porto_sal_fan_club_en.py',
    'render_frontier_service_rooms_en.py',
    'render_daycare_and_bases_en.py',
    'render_desert_pass_and_falls_en.py',
    'render_aguas_mboi_interiors_en.py',
    'render_crafts_and_captions_en.py',
    'render_field_and_services_en.py',
    'render_trick_house_rooms_en.py',
    'render_specialist_houses_en.py',
    'render_rest_houses_en.py',
...
if len(extra_overlays) != 106:
    fail(f"expected 106 final transactional overlay files, found {len(extra_overlays)}")
