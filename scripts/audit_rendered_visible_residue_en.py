...
STALE_VISIBLE_PLACES = (
    ...
    # Renamed on the region map and the landmark bar; dialogue still says these.
    "PETALBURG WOODS", "ABANDONED SHIP", "SHOAL CAVE", "FIERY PATH",
    "JAGGED PASS", "ISLAND CAVE", "DESERT RUINS", "SCORCHED SLAB",
    "ANCIENT TOMB", "SEALED CHAMBER", "MIRAGE TOWER", "MIRAGE ISLAND",
    "SOUTHERN ISLAND", "ARTISAN CAVE", "ALTERING CAVE", "DESERT UNDERPASS",
    "TRAINER HILL",
)
