...
RAW_MARKERS = {
    ...
    "FortreeCity_House1_Text_GoingToMakeVolbeatStrong": ("Lixao super",),
    ...
    "FortreeCity_House4_Text_AskedWingullToRunErrand": ("asked my Foliao",),
    "FortreeCity_House4_Text_WelcomeWingullTakeMentalHerb": ("MENTAL HERB",),
    "FortreeCity_House4_Text_FriendsFarAwayThanksToWingull": ("friends", "Foliao"),
