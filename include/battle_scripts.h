...
extern const u8 BattleScript_AraunaSouthWindEnd3[];
extern const u8 BattleScript_AraunaLongNightEnd3[];
extern const u8 BattleScript_AraunaSouthWind[];
extern const u8 BattleScript_AraunaLongNight[];
extern const u8 BattleScript_AraunaOathActivates[];
extern const u8 BattleScript_AraunaRainbowArc[];
extern const u8 BattleScript_AraunaManyRivers[];
