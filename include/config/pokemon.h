...
#define P_GBA_STYLE_SPECIES_GFX         TRUE        // Arauna follows Pokémon Emerald's native GBA visual language.
#define P_GBA_STYLE_SPECIES_ICONS       TRUE        // Keep menu icons consistent with the Emerald-era battle sprites.
#define P_GBA_STYLE_SPECIES_FOOTPRINTS  TRUE        // Use GBA-era footprints throughout the regional Dex.
